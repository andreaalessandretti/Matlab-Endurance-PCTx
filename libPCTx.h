/*
 * Copyed from Endurance R/C PCTx cable examples
 */
...
int rawhid_send(int num, void *buf, int len, int timeout)
{
	...
	// device
	// report type,
	// CFIndex for the report ID,
	// report buffer,
	// report buffer length
	
	ret = IOHIDDeviceSetReport(hid->ref, kIOHIDReportTypeOutput, 0x00, buf, len);
